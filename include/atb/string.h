...
/// Construct a StrView to the given other/size
extern void atb_StrView_Set(struct atb_StrView *const view, const char *other,
                            size_t size) ATB_PUBLIC;

/// Set a StrView from a NULL terminated string
extern void atb_StrView_Set_NullTerminated(struct atb_StrView *const view,
                                           const char *other) ATB_PUBLIC;
...
/// Construct a StrSpan to the given other/size
extern void atb_StrSpan_Set(struct atb_StrSpan *span, char *other,
                            size_t size) ATB_PUBLIC;

/// Set a StrSpan from a NULL terminated string
extern void atb_StrSpan_Set_NullTerminated(struct atb_StrSpan *span,
                                           char *other) ATB_PUBLIC;
...
static inline struct atb_StrView atb_StrView_From(const char *other,
  ...
  atb_StrView_Set(&view, other, size);
  return view;
}
...
static inline struct atb_StrView atb_StrView_From_NullTerminated(
    const char *other) {
  struct atb_StrView view;
  atb_StrView_Set_NullTerminated(&view, other);
  return view;
}
...
static inline struct atb_StrSpan atb_StrSpan_From(char *other, size_t size) {
  ...
  atb_StrSpan_Set(&span, other, size);
  return span;
}

static inline struct atb_StrSpan atb_StrSpan_From_NullTerminated(char *other) {
  struct atb_StrSpan span;
  atb_StrSpan_Set_NullTerminated(&span, other);
  return span;
}
